...
--gradient-accent:   linear-gradient(90deg, #00d9a3 0%, #06b981 100%)   /* 成功状態 */
--gradient-music:    linear-gradient(90deg, #ff8c42 0%, #ffa55c 100%)   /* 音楽関連要素 */
--gradient-timeline: linear-gradient(90deg, #ff8c42 0%, #00d9a3 50%, #5b6dee 100%) /* タイムラインバー */

/* インタラクション用 */
--gradient-hover:   linear-gradient(135deg, #ffa55c 0%, #ffb876 100%)
--gradient-active:  linear-gradient(135deg, #ff7728 0%, #ff8c42 100%)
--gradient-surface: linear-gradient(180deg, #fff9f5 0%, #fff5eb 100%)   /* ページ背景用 */
--gradient-card:    linear-gradient(135deg, #fffbf7 0%, #fff5f0 100%)   /* カード背景用 */
```
...
- `focus-visible:ring-1 focus-visible:ring-ring`（button.tsx の基本スタイル）
