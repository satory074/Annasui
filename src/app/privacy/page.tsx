      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">3. 情報の第三者提供</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">4. データの保存・削除</h2>
              <div className="text-gray-700 mb-4">
                <p className="mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">5. セキュリティ</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Cookie・ローカルストレージについて</h2>
              <p className="text-gray-700 mb-4">
