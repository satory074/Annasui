      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第3条（利用者の責務）</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第4条（コンテンツについて）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第6条（規約の変更）</h2>
              <p className="text-gray-700 mb-4">
