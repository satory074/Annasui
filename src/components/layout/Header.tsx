            ...
            <form onSubmit={onVideoIdSubmit} className="flex gap-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 text-gray-900 bg-white rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                />
              </div>
              <Button type="submit">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
